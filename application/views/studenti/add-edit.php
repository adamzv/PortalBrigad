      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="meno" name="meno" value="<?php echo !empty($post['meno']) ? $post['meno'] : ''; ?>">
          </div>
          <div class="form-group">
            <label for="priezvisko">Priezvisko:</label>
            <input type="text" class="form-control" id="priezvisko" name="priezvisko" value="<?php echo !empty($post['priezvisko']) ? $post['priezvisko'] : ''; ?>">
          </div>
          <div class="form-group">
